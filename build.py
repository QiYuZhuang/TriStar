...
# 设置目标目录
target_dir = os.path.join(parent_project_dir, "targets")
...
# compile all modules
subprocess.run(["mvn", "clean", "install", "-Dmaven.test.skip=true", "-Dmaven.javadoc.skip=true"], cwd=parent_project_dir, check=True)
...
conf_dir = parent_project_dir + "/config"
