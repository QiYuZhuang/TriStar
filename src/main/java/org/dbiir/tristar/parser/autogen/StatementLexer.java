...
public class StatementLexer extends Lexer {
	...
	public static final int
		...
		IDENTIFIER_=810, NOT_SUPPORT_=811;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "BLOCK_COMMENT", "INLINE_COMMENT", "AND_", "OR_", "NOT_", 
			...
			"Z", "UL_", "FILESIZE_LITERAL", "SINGLE_QUOTED_TEXT", "DOUBLE_QUOTED_TEXT", 
