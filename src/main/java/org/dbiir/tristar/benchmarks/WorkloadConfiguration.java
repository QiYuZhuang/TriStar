   ...
   public void setConcurrencyControlType(String type) {
     switch (type) {
       ...
       case "SI":
         ...
         break;
       case "RC_TAILOR_ATTR":
         this.concurrencyControlType = CCType.RC_TAILOR_ATTR;
         break;
       case "RC_FOR_UPDATE_ATTR":
         this.concurrencyControlType = CCType.RC_FOR_UPDATE_ATTR;
         break;
       case "RC_ELT_ATTR":
         this.concurrencyControlType = CCType.RC_ELT_ATTR;
         break;
       default:
